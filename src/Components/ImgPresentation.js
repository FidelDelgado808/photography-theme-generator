...
return(
  ...
  <div className="row">
    <div className="column">
      <img className="w-full" src={imageSelector.img1}  onclick="currentSlide(1)" alt="The Woods"/>
    </div>
    <div className="column">
      <img className="w-full" src={imageSelector.img2}  onclick="currentSlide(2)" alt="Cinque Terre"/>
    </div>
    <div className="column">
      <img className="w-full" src={imageSelector.img3}  onclick="currentSlide(3)" alt="Mountains and fjords"/>
    </div>
    <div className="column">
      <img className="w-full" src={imageSelector.img4}  onclick="currentSlide(4)" alt="Northern Lights"/>
    </div>
    <div className="column">
      <img className="w-full" src={imageSelector.img5}   onclick="currentSlide(5)" alt="Nature and sunrise"/>
    </div>
    <div className="column">
      <img className="w-full" src={imageSelector.img6}   onclick="currentSlide(6)" alt="Snowy Mountains"/>
    </div>
  </div>
</div>
